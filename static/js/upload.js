...
let isAdvancedUpload = function() {
  ...
  function P_to_hide() {
    document.getElementById("fileP").style.display = 'none';
    document.querySelector(".browse-files-text").style.display = 'none';
    document.querySelector(".browse-files-or-text").style.display = 'none';
  }
  ...
  fileInput.addEventListener("change", e => {
      ...
      dragDropText.innerHTML = 'File Added Successfully!';
